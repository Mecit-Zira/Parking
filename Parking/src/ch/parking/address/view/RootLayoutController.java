...
public class RootLayoutController {
    ...
    private void handleNew() {
        mainApp.getParkingData().clear();
        mainApp.setParkingFilePath(null);
    }
    ...
    private void handleOpen() {
        ...
        if (file != null) {
            mainApp.loadParkingDataFromFile(file);
        }
    }
    ...
    private void handleAbout() {
        ...
        alert.setContentText("Author: Mecit Zira\nWebsite: http://code.parking.ch");
